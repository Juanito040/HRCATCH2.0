...
SysProtocoloPreventivo.belongsTo(TipoEquipo, { foreignKey: 'id_tipo_equipo_fk', as: 'tipoEquipo' });
TipoEquipo.hasMany(SysProtocoloPreventivo, { foreignKey: 'id_tipo_equipo_fk', as: 'sysProtocolos' });
