...
export class MesaService {
    ...
    getCasosPorEquipo(id_sysequipo: number): Observable<{ success: boolean; data: any[] }> {
        return this.http.get<{ success: boolean; data: any[] }>(`${this.apiUrl}/casos/equipo/${id_sysequipo}`, this.createHeaders());
    }
